import { NavLink } from "@/ui/lib/router";
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          ...
          isActive
            ? "bg-accent/30 text-foreground border-l-2 border-primary dark:glow-text-green"
            : "text-foreground/80 hover:bg-accent/20 hover:text-foreground border-l-2 border-transparent",
          className,
        )
      }
    >
