...
import { Link, Outlet, useLocation, useNavigate, useParams } from "@/ui/lib/router";
...
import { Tooltip, TooltipTrigger, TooltipContent } from "@/ui/components/ui/tooltip";
...
export function Layout() {
  ...
  const { data: health } = useQuery({
    ...
    refetchInterval: (query) => {
      ...
      return pageVisible && data?.devServer?.enabled ? 5_000 : false;
    },
